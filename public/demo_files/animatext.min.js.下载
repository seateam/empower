		...
		return a.fn.animatext = function(b) {
			...
			b), c = function(b) {
				...
				if (d.onBegin(), c = [], g = !1, d.group ? a(b).each(function(b, d) {
					return a(d).css("visibility", "hidden"),
					c.push(d)
					...
					var e;
					return e = a(d).find("span[class^='char']"),
					...
					for (e = [], n = c.length, q = k = o = n; o <= 1 ? k <= 1 : k >= 1; q = o <= 1 ? ++k: --k) m = Math.floor(Math.random() * c.length),
					e.push(c[m]),
					c.splice(m, 1);
					c = e
				}
				return p = function(b) {
					return d.group ? a(b).each(function(b, c) {
						return a(c).css("visibility", "hidden"),
						a(c).removeClass("animated"),
						a(c).removeClass(d.effect)
					}) : (b.find("span").css("visibility", "hidden"), b.find("span").removeClass("animated"), b.find("span").removeClass(d.effect)),
					j()
				},
				j = function() {
					var e, f;
					...
					e = setInterval(function() {
						...
						d.timeToRelaunch)),
						a(c[f]).css("visibility", "visible"),
						d.effect && a(c[f]).addClass("animated " + d.effect),
						f += 1
					},
					d.speed)
				},
