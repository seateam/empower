import { version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, defineAsyncComponent, h, inject, onUnmounted, useSSRContext, shallowReactive, Suspense, nextTick, Transition, unref, computed, resolveComponent, Fragment, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString as toDisplayString$1, createApp, effectScope, reactive, hasInjectionContext, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isRef, isReactive, toRaw, isReadonly, getCurrentScope, onScopeDispose, Text, markRaw, toRefs, isShallow } from 'vue';
import { $ as $fetch, l as defu, m as createHooks, h as createError$1, n as sanitizeStatusCode, t as toRouteMatcher, o as createRouter$1, p as getRequestHeaders, q as klona, r as parse$1, v as getRequestHeader, w as destr, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../runtime.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead_P9hXGSPtSh = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contact-Cf8KweNf.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-B8dLKDT-.mjs').then((m) => m.default || m)
  },
  {
    name: "relation",
    path: "/relation",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./relation-DbELTMQ1.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_6dOL3Kz5vl = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyArcFooter = defineAsyncComponent(() => Promise.resolve().then(function() {
  return index;
}).then((r) => r["default"] || r.default || r));
const LazyArcHead = defineAsyncComponent(() => Promise.resolve().then(function() {
  return index$1;
}).then((r) => r["default"] || r.default || r));
const LazyArcHome = defineAsyncComponent(() => import('./index-_JL_Ysfq.mjs').then((r) => r["default"] || r.default || r));
const LazyArcSection2 = defineAsyncComponent(() => import('./section2-hTQhN0v2.mjs').then((r) => r["default"] || r.default || r));
const LazyArcSection3 = defineAsyncComponent(() => import('./section3-Cl7PTfE3.mjs').then((r) => r["default"] || r.default || r));
const LazyArcSection4 = defineAsyncComponent(() => import('./section4-DzonugXB.mjs').then((r) => r["default"] || r.default || r));
const LazyArcSection5 = defineAsyncComponent(() => import('./section5-DLWCCmfD.mjs').then((r) => r["default"] || r.default || r));
const LazyArcSection6 = defineAsyncComponent(() => import('./section6-CSVh9cQ6.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["ArcFooter", LazyArcFooter],
  ["ArcHead", LazyArcHead],
  ["ArcHome", LazyArcHome],
  ["ArcSection2", LazyArcSection2],
  ["ArcSection3", LazyArcSection3],
  ["ArcSection4", LazyArcSection4],
  ["ArcSection5", LazyArcSection5],
  ["ArcSection6", LazyArcSection6]
];
...
const plugin_xuy7MCCzJQ = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const config = /* @__PURE__ */ useRuntimeConfig();
...
const plugin_server_m8f6ssOQJR = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a;
...
const vueI18nConfigs = [
  () => import(
    './nuxt-i18n-CT4j5QU5.mjs'
    /* webpackChunkName: "__nuxt_i18n_ts_369546b3" */
  )
];
...
const switch_locale_path_ssr_AWorEsbPLU = /* @__PURE__ */ defineNuxtPlugin({
...
const i18n_8lN1k1cFBt = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
...
const plugins = [
  ...
  plugin$1,
  plugin,
  revive_payload_server_6dOL3Kz5vl,
  components_plugin_KR1HBZs4kY,
  plugin_xuy7MCCzJQ,
  plugin_server_m8f6ssOQJR,
  switch_locale_path_ssr_AWorEsbPLU,
  i18n_8lN1k1cFBt,
...
const _imports_0 = publicAssetsURL("/img/files/clogo.png");
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isActive = (path) => route.path === path && !(void 0).location.hash;
    const isAnchorActive = (hash) => (void 0).location.hash === hash;
    ...
    const headerBackground = computed(
      () => isContactRoute.value ? "rgba(255, 255, 255, 1)" : headerOpacity.value === 1 ? "rgba(255, 255, 255, 1)" : `rgba(255, 255, 255, ${headerOpacity.value * 0.65})`
      // 滚动未超过 64px 背景逐渐透明
    );
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "em-head",
        style: { backgroundColor: unref(headerBackground) },
        class: { theme: unref(headerOpacity) === 1, "theme-contact": unref(isContactRoute) }
      }, _attrs))} data-v-1ebc8b21><div class="em-head-box" data-v-1ebc8b21>`);
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="" data-v-1ebc8b21${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<ul data-v-1ebc8b21><li data-v-1ebc8b21>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref($t)("home-page"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref($t)("home-page")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li data-v-1ebc8b21>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/#about-us",
        class: { active: isAnchorActive("#about-us") }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref($t)("about-us"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref($t)("about-us")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/#company",
        class: { active: isAnchorActive("#company") }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref($t)("company-product"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref($t)("company-product")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref($t)("contact-us"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(unref($t)("contact-us")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul><div class="right" data-v-1ebc8b21><div class="language-switch" data-v-1ebc8b21><div class="${ssrRenderClass({ active: unref(userStore).languageActive === 1 })}" data-v-1ebc8b21> EN </div><div class="${ssrRenderClass({ active: unref(userStore).languageActive === 2 })}" data-v-1ebc8b21> 繁 </div><div class="${ssrRenderClass({ active: unref(userStore).languageActive === 0 })}" data-v-1ebc8b21> 简 </div></div></div></div></div>`);
    };
  }
});
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/arc/head/index.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-1ebc8b21"]]);
...
const _imports_1 = publicAssetsURL("/img/files/ewm.png");
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { t: $t } = useI18n();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "em-footer" }, _attrs))} data-v-b0decdc7><div class="foot" data-v-b0decdc7><div class="ftLeft" data-v-b0decdc7><p data-v-b0decdc7>${ssrInterpolate(unref($t)("footer-address"))}</p><p data-v-b0decdc7>${ssrInterpolate(unref($t)("footer-phone"))}</p><p data-v-b0decdc7><a href="http://beian.miit.gov.cn/" data-v-b0decdc7>${ssrInterpolate(unref($t)("footer-icp"))}</a> ${ssrInterpolate(unref($t)("footer-all"))}</p></div><div class="ftRight" data-v-b0decdc7><img${ssrRenderAttr("src", _imports_1)} data-v-b0decdc7><span data-v-b0decdc7>${ssrInterpolate(unref($t)("company-name"))}</span></div></div></div>`);
    };
  }
});
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/arc/footer/index.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b0decdc7"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useUserStore();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_arc_head = __nuxt_component_0;
      const _component_nuxt_page = __nuxt_component_1;
      const _component_arc_footer = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_arc_head, null, null, _parent));
      _push(ssrRenderComponent(_component_nuxt_page, { class: "page" }, null, _parent));
      _push(ssrRenderComponent(_component_arc_footer, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BBoHFq_b.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-C_SMCCec.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@opentelemetry+api@1.8.0_@parcel+watcher@2.4.1_@types+node@20.12.12_@unocss+reset_227qoqayto7wcrj4s2p6ltx3vu/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@opentelemetry+api@1.8.0_@parcel+watcher@2.4.1_@types+node@20.12.12_@unocss+reset_227qoqayto7wcrj4s2p6ltx3vu/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useI18n as b, _imports_1 as c, entry$1 as default, useHead as u };
