...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Powerwin"}],"link":[{"rel":"icon","href":"/logo.png"}],"style":[],"script":[],"noscript":[],"title":"Powerwin"};
